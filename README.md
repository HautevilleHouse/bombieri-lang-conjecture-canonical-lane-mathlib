# Bombieri Lang Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/bombieri-lang-conjecture-canonical-lane-mathlib.git
cd bombieri-lang-conjecture-canonical-lane-mathlib
lake exe
lake build
```
